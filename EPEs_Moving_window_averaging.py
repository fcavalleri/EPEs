...
n_days_in_season = [90, 92, 92, 91]  # number of days in each season (DJF, MAM, JJA, SON)
vars_to_avg = ["tot_tp_norm", "km_scale", "tp_max","eccentricity"]
...
for seas in seasons:
    ...
    df_counts_avg.to_csv(path_out + 'pctl_EXTR_eachyr_Seas_EventBased_Mean_counts_' + seas + '.txt', sep=' ', index=False)
    df_km_scale_avg.to_csv(path_out + 'pctl_EXTR_eachyr_Seas_EventBased_Mean_km_scale_' + seas + '.txt', sep=' ', index=False)
    df_tp_max_avg.to_csv(path_out + 'pctl_EXTR_eachyr_Seas_EventBased_Mean_tp_max_' + seas + '.txt', sep=' ', index=False)
    df_tot_tp_avg.to_csv(path_out + 'pctl_EXTR_eachyr_Seas_EventBased_Mean_tot_tp_' + seas + '.txt', sep=' ', index=False)
    df_eccentricity_avg.to_csv(path_out + 'pctl_EXTR_eachyr_Seas_EventBased_Mean_eccentricity_' + seas + '.txt', sep=' ', index=False)
    df_freq_wet.to_csv(path_out + 'pctl_EXTR_eachyr_Seas_EventBased_Mean_freq_wet_' + seas + '.txt', sep=' ', index=False)
